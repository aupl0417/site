...
require_once VENDOR_PATH . "weixinPay/SDKRuntimeException.php";
//require_once "WxPay.Config.php";
require_once VENDOR_PATH . "weixinPay/WxPay.Pub.Config.php";
...
class WxPayApi
{
	...
	public static function orderQuery($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(WxPayConf_pub::APPID);//公众账号ID
		$inputObj->SetMch_id(WxPayConf_pub::MCHID);//商户号
		$inputObj->SetNonce_str(self::getNonceStr());//随机字符串
