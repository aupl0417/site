...
class Html extends TagLib{
     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            case 'UBB':
                ...
                break;
            case 'KINDEDITOR':
                $parseStr   =  '<textarea  id="'.$id.'" style="'.$style.'" name="'.$name.'" data-type="kindeditor">'.$content.'</textarea >';
                break;
            case 'REDACTOR':
                $parseStr   =  '<textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" data-type="editor">'.$content.'</textarea>';
                break;
            case 'CKEDITOR':
                $parseStr   =  '<textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" class="ckeditor">'.$content.'</textarea><script type="text/javascript">CKEDITOR.replace("'.$id.'");</script>';
                break;
            case 'WANGEDIT':
                $parseStr   =  '<textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" class="wangedit">'.$content.'</textarea>';
                break;
            case 'UEDITOR':
                $parseStr   =  '<textarea  id="'.$id.'" style="'.$style.'" name="'.$name.'" data-type="ueditor">'.$content.'</textarea >';
                break;
    ...
    public function _select($tag) {
        ...
        if(!empty($first)) {
            $parseStr .= '<option value="'.$first_value.'" >'.$first.'</option>';
        }
        if(!empty($options)) {
