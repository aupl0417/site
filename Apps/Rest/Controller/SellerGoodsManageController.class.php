...
class SellerGoodsManageController extends CommonController {
    ...
    */
    public function goods_all(){
        ...
        $pagelist=pagelist(array(
                ...
                'map'       =>$map,
                'order'     =>'id desc',
                'fields'    =>'id,atime,uptime,category_id,shop_category_id,goods_name,images,price,num,sale_num,score_ratio,code,is_best,status,express_tpl_id,score_ratio,is_collection,score_type',
                'pagesize'  =>$pagesize,
                'relation'  =>'attr_list',
...
writeLog($pagelist);
    ...
    */
    public function category(){
        ...
        $list=get_category(['table' => 'shop_goods_category' , 'level' => 2,'field'=>'id,sid,category_name,icon,sort,atime,category_type' , 'map' => [0 => ['uid' => $this->uid]]]);
        if($list){
