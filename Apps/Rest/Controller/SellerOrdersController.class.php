...
class SellerOrdersController extends CommonController {
...
//        }
	...
	*/
	public function orders_logs(){
        ...
        $orders=new \Common\Controller\OrdersController(array('seller_id'=>$this->uid,'s_no'=>I('post.s_no')));
    ...
    */
    public function orders_list(){
        ...
        $orders=new \Common\Controller\SellerOrdersController(array('seller_id'=>$this->uid));
        $res=$orders->s_orders_list(I('post.'));
        $this->apiReturn($res['code'],array('data'=>$res['data']),1,$res['msg']);                     
    }
