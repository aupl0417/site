    ...
    <div class="centent_body">
        ...
        <div class="revision_bg">
            <div class="container ptb_size_lg clearfix">
                <!-- 左侧导航 -->
                <div class="revisionLeft controller-active" data-controller="/Index" data-url="/" style="width: 150px;">
    <div class="pb10">
        <?php $_result=getShopMenu();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["position"]) == "4"): ?><div class="user_left_tle">
                ...
                <div class="revisionRight pd15" style="width: 1020px"><!-- 右侧内容 -->
                    ...
                    <div class="row">
                        <div class="col-sm-8" style="border-right: solid 1px #F8F8F8">
                            <h4>商家信息</h4>
                            <p>
                                <a href="<?php echo U('/setting');?>"><img class="fl mr15" width="100" src="<?php echo myurl($shop['shop_logo'],120);?>"></a>
                                <a href="<?php echo U('/setting');?>" class="ab text-center set_shop" style="left: 15px; top: 110px;">设置店标</a>
                            </p>
                            <p>
                                店铺名称：<strong class="text_yellow"><?php echo ($shop["shop_name"]); ?></strong>
                            </p>
                            <p>
                                主营类目：<strong class="text_yellow"><?php echo implode(',',$shop['category_name']);?></strong>
                            </p>
                            <p>
                                店铺类型：<strong class="text_yellow"><?php echo ($shop["type_name"]); ?></strong>
                            </p>
                            <p>
                                认证状态：<img class="mr5" src="/Public/new_design/images/voucher_1.png"><img class="mr5" src="/Public/new_design/images/voucher_2.png">
                            </p>
                            <div class="clear"></div>
                            <p class="text-center mt20 hide">
                                <a class="text_blue" href="<?php echo U('/setting');?>"><strong>店铺设置</strong></a>
                                <span class="plr5">|</span>
                                <a class="text_blue" href="<?php echo ($shop["shop_url"]); ?>" target="_blank"><strong>查看我的店铺</strong></a>
                            </p>
                        </div>
                        <div class="col-sm-4 hide">
                            <h4>账户资产</h4>
                            <p>
                                账户余额：￥ <strong class="text_yellow"><?php echo ($account["a_freeMoney"]); ?></strong> 元
                            </p>
                        </div>
                        <div class="col-sm-4" style="border-left: solid 1px #F8F8F8">
                            <h4>昨日店铺数据</h4>
                            <p>
                                订单数 (<strong class="text_yellow"><?php echo ($total["sale_total"]["num"]); ?></strong>)
                            </p>
                            <p>
                                销售额 (<strong class="text_yellow"><?php echo ($total["sale_total"]["money"]); ?></strong>)
                            </p>
                            <p>
                                商品数 (<strong class="text_yellow"><?php echo ($total["sale_total"]["goods_num"]); ?></strong>)
                            </p>
                            <p>
                                买家数 (<strong class="text_yellow"><?php echo ($total["sale_total"]["buyer"]); ?></strong>)
                            </p>
                            <p>
                                客单数 (<strong class="text_yellow"><?php echo ($total["sale_total"]["price"]); ?></strong>)
                            </p>
                            <p class="hide">
                                退款数 (<strong class="text_yellow"><?php echo ($total["sale_total"]["refund"]); ?></strong>)
                            </p>

                        </div>
                    </div>

                    <div class="row pd10 mt30" style="border-top: solid 1px #F8F8F8">
                        <div class="col-md-4 col-sm-4">
                            <h4>订单管理</h4>
                            <p>
                                <a href="<?php echo U('/orders/index', ['sid' => 2]);?>">待发货 (<strong class="text_yellow"><?php echo ($total["orders"]["2"]); ?></strong>)</a>
                            </p>
                            <p>
                                <a href="<?php echo U('/orders/index', ['sid' => 1]);?>">待付款 (<strong class="text_yellow"><?php echo ($total["orders"]["1"]); ?></strong>)</a>
                            </p>
                            <p class="hide">
                                <a href="<?php echo U('/orders/index', ['sid' => 4]);?>">待评价 (<strong class="text_yellow"><?php echo ($total["orders"]["4"]); ?></strong>)</a>
                            </p>
                            <p class="hide">
                                <a href="<?php echo U('/refund');?>">退款中 (<strong class="text_yellow"><?php echo ($total["orders"]["20"]); ?></strong>)</a>
                            </p>
                        </div>
                        <div class="col-md-4 col-sm-4" style="border-left: solid 1px #F8F8F8;border-right: solid 1px #F8F8F8">
                            <h4>商品管理</h4>
                            <p>
                                <a target="_blank" href="<?php echo DM('sell');?>?url=/goods/index/status/1">出售中 (<strong class="text_yellow"><?php echo ($total["goods"]["1"]); ?></strong>)</a>
                            </p>
                            <p>
                                <a target="_blank" href="<?php echo DM('sell');?>?url=/goods/index/status/2">待上架 (<strong class="text_yellow"><?php echo ($total["goods"]["2"]); ?></strong>)</a>
                            </p>
                            <p>
                                <a target="_blank" href="<?php echo DM('sell');?>?url=/goods/index/is_best/1">橱窗中 (<strong class="text_yellow"><?php echo ($total["goods"]["best"]); ?></strong>)</a>
                            </p>
                            <p>
                                <a target="_blank" href="<?php echo DM('sell');?>?url=/goods/index/status/4">违规中 (<strong class="text_yellow"><?php echo ($total["goods"]["4"]); ?></strong>)</a>
                            </p>
                        </div>
                        <div class="col-md-4 col-sm-4 hide">
                            <h4>违规记录</h4>
                            <p>
                                一般违规商品数量 (<strong class="text_yellow"><?php echo ($total["illegl"]["1"]); ?></strong>)
                            </p>
                            <p>
                                严重违规商品数量 (<strong class="text_yellow"><?php echo ($total["illegl"]["2"]); ?></strong>)
                            </p>
                        </div>
                    </div>

                    <div class="row pd10 text-center mt30 hide" style="border-top: solid 1px #F8F8F8">
                        <div class="col-md-2 col-sm-2 pd20">
                            <a class="hover_bg" href="<?php echo U('/orders/index', ['sid' => 2]);?>">
                                <img class="mg15" src="/Public/new_design/images/sell_1.png">
                                <p class="mb20">订单发货</p>
                            </a>
                        </div>
                        <div class="col-md-2 col-sm-2 pd20">
                            <a class="hover_bg" href="<?php echo U('/refund');?>">
                                <img class="mg15" src="/Public/new_design/images/sell_2.png">
                                <p class="mb20">退货管理</p>
                            </a>
                        </div>
                        <div class="col-md-2 col-sm-2 pd20">
                            <a class="hover_bg" href="<?php echo U('/refund');?>">
                                <img class="mg15" src="/Public/new_design/images/sell_3.png">
                                <p class="mb20">退款列表</p>
                            </a>
                        </div>
                        <div class="col-md-2 col-sm-2 pd20">
                            <a class="hover_bg" href="<?php echo DM('ad');?>">
                                <img class="mg15" src="/Public/new_design/images/sell_4.png">
                                <p class="mb20">广告位购买</p>
                            </a>
                        </div>
                        <div class="col-md-2 col-sm-2 pd20">
                            <a class="hover_bg" href="<?php echo U('/activity');?>">
                                <img class="mg15" src="/Public/new_design/images/sell_5.png">
                                <p class="mb20">促销管理 </p>
                            </a>
                        </div>
                        <div class="col-md-2 col-sm-2 pd20">
                            <a class="hover_bg" href="<?php echo U('/brand');?>">
                                <img class="mg15" src="/Public/new_design/images/sell_6.png">
                                <p class="mb20">我的品牌</p>
                            </a>
                        </div>
                    </div>
