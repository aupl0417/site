...
<head>
	...
	<script>
		var ACTION	=	'<?php echo enCryptRestUri("/Express/index");?>';
	</script>
</head>
    ...
    <div class="centent_body">
        ...
        <div class="revision_bg">
            <div class="container ptb_size_lg clearfix">
                <!-- 左侧导航 -->
                <div class="revisionLeft controller-active" data-controller="/Express" data-url="/express.html" style="width: 150px;">
    <div class="pb10">
        <?php $_result=getShopMenu();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["position"]) == "4"): ?><div class="user_left_tle">
                ...
                <div class="revisionRight pd15" style="width: 1020px"><!-- 右侧内容 -->
                    <div class="clearfix revisionOrderTab" data-url="">
                        <a class="fr btn btn-primary" href="<?php echo U('/express/add');?>">创建运费模板</a>
                    ...
                    <div class="content mt30">
                        <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table class="md20" id="<?php echo ($vo["id"]); ?>">
                                    <thead>
                                    <tr>
                                        <th colspan="6">
                                            <div class="pull-right">
                                                <a href="/Express/edit/id/<?php echo ($vo["id"]); ?>" class="btn btn-info">修改</a>
                                                <div class="btn btn-primary" onclick="express_delete($(this))" data-id="<?php echo ($vo["id"]); ?>">删除</div>
                                            </div>
                                            <h4><?php echo ($vo["tpl_name"]); ?></h4>
                                        </th>
                                    </tr>
                                    <?php if(($vo["is_free"]) == "0"): ?><tr>
                                            <th class="text-center" width="100">运送方式</th>
                                            <th class="text-center">运送到</th>
                                            <th class="text-center" width="100">首<?php echo ($vo['unit']==1?'件':'重'); ?></th>
                                            <th class="text-center" width="100">运费(元)</th>
                                            <th class="text-center" width="100">续<?php echo ($vo['unit']==1?'件':'重'); ?></th>
                                            <th class="text-center" width="100">运费(元)</th>
                                        </tr><?php endif; ?>
                                    </thead>

                                    <tbody class="tm">
                                    <?php if(($vo["is_free"]) == "0"): if(($vo["is_express"]) == "1"): ?><tr>
                                                <td class="text-center">快递</td>
                                                <td>默认地区</td>
                                                <td class="text-center"><?php echo ($vo["express_default_first_unit"]); ?></td>
                                                <td class="text-center"><?php echo ($vo["express_default_first_price"]); ?></td>
                                                <td class="text-center"><?php echo ($vo["express_default_next_unit"]); ?></td>
                                                <td class="text-center"><?php echo ($vo["express_default_next_price"]); ?></td>
                                            </tr><?php endif; ?>
                                        <?php if(($vo["is_ems"]) == "1"): ?><tr>
                                                <td class="text-center">EMS</td>
                                                <td>默认地区</td>
                                                <td class="text-center"><?php echo ($vo["ems_default_first_unit"]); ?></td>
                                                <td class="text-center"><?php echo ($vo["ems_default_first_price"]); ?></td>
                                                <td class="text-center"><?php echo ($vo["ems_default_next_unit"]); ?></td>
                                                <td class="text-center"><?php echo ($vo["ems_default_next_price"]); ?></td>
                                            </tr><?php endif; ?>
                                        <?php if(is_array($vo["express_area"])): $i = 0; $__LIST__ = $vo["express_area"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i; if(($vo["is_express"]) == "1"): if(($a["type"]) == "1"): ?><tr>
                                                        <td class="text-center"><?php echo ($a['type']==1?'快递':'EMS'); ?></td>
                                                        <td><?php echo ($a["city"]); ?></td>
                                                        <td class="text-center"><?php echo ($a["first_unit"]); ?></td>
                                                        <td class="text-center"><?php echo ($a["first_price"]); ?></td>
                                                        <td class="text-center"><?php echo ($a["next_unit"]); ?></td>
                                                        <td class="text-center"><?php echo ($a["next_price"]); ?></td>
                                                    </tr><?php endif; endif; ?>
                                            <?php if(($vo["is_ems"]) == "1"): if(($a["type"]) == "2"): ?><tr>
                                                        <td class="text-center"><?php echo ($a['type']==1?'快递':'EMS'); ?></td>
                                                        <td><?php echo ($a["city"]); ?></td>
                                                        <td class="text-center"><?php echo ($a["first_unit"]); ?></td>
                                                        <td class="text-center"><?php echo ($a["first_price"]); ?></td>
                            ...
                            <?php else: ?>
                            <div class="nors text-center">还未设置运费模板</div><?php endif; ?>
                    </div>
