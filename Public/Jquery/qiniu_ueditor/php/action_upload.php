...
if(!empty($result['hash'])){
    ...
    //$api_host='http://rest'.strstr($_SERVER['HTTP_HOST'],'.');
    //$res=curl_post($api_host.'/Config/save_file',array('ak'=>101138195,'sk'=>'bf701490797ea7390333be017fbe786a','code'=>session_id(),'url'=>$url,'name'=>$_FILES[$fieldName]['name'],'key'=>$result['key'],'size'=>$_FILES[$fieldName]['size']));
